...
<div class="snippet" is="layout-project">
  <div class="project project_davide-rizzo context-content">
    <section class="project__layout">
      <header class="project__header">
        <div class="container">
          <h1 class="project__title">Davide Rizzo</h1>
        </div>
      </header>
      ...
      <footer class="project__footer">
        <div class="container">
          <a class="button button__circle" href="https://www.daviderizzoarchitects.com/" target="_blank" rel="noreferrer noopener" aria-label="Open Project URL">
