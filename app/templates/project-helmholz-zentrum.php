...
<div class="layout-project">
  <div class="project project_helmholz-zentrum context-content">
    <section class="project__layout">
      ...
      <main class="project__main">
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/hzb__home__1440-1600-browser.png" alt="Helmholz Zentrum Layout Home">
            </div>
          </div>
        </div>
        ...
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/hzb__home-search__1440-1600-browser.png" alt="Helmholz Zentrum Search">
            </div>
          </div>
        </div>
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/hzb__home-menu__1440-1600-browser.png" alt="Helmholz Zentrum Menu">
            </div>
          </div>
        </div>
      </main>
      <footer class="project__footer">
        <div class="container">
          <a class="button button_circle" aria-label="Open Project URL" href="https://www.helmholtz-berlin.de/" target="_blank" rel="noreferrer noopener">
