...
<div class="layout-project">
  <div class="project project_rohde-und-schwarz context-content">
    <section class="project__layout">
      <header class="project__header">
        <div class="container">
          <h1 class="project__title">Rohde und Schwarz</h1>
        </div>
      </header>
      <main class="project__main">
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/rohde-und-schwarz__product__960-1360-browser.png" alt="Rohde und Schwarz Layout Product">
            </div>
          </div>
        </div>
        ...
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/rohde-und-schwarz__filter__960-1360-browser.png" alt="Rohde und Schwarz List Filter">
            </div>
          </div>
        </div>
      </main>
