...
<div class="layout-project">
  <div class="project project_deutsche-filmakademie context-content">
    <section class="project__layout">
      <header class="project__header">
        <div class="container">
          <h1 class="project__title">Deutsche Filmakademie</h1>
        </div>
      </header>
      <main class="project__main">
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/dfa__home__1440-1600-browser.png" alt="Deutsche Filmakademie Layout Home">
            </div>
          </div>
        </div>
        ...
        <div class="project__image project__image_desktop">
          <div class="container">
            <div class="image">
              <img class="image__tag" src="../assets/images/dfa__events__1440-1600-browser.png" alt="Deutsche Filmakademie Layout Events">
            </div>
          </div>
        </div>
      </main>
      <footer class="project__footer">
        <div class="container">
          <a class="button button_circle" aria-label="Open Project URL" href="https://www.deutsche-filmakademie.de/" target="_blank" rel="noreferrer noopener">
