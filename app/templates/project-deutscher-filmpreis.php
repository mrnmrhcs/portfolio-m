  ...
  <div class="project project_deutscher-filmpreis context-content">
    <section class="project__layout">
      <header class="project__header">
        <div class="container">
          <h1 class="project__title">Deutscher Filmpreis</h1>
        </div>
      </header>
      ...
      <footer class="project__footer">
        <div class="container">
          <a class="button button__circle" href="https://www.deutscher-filmpreis.de/" target="_blank" rel="noreferrer noopener">
